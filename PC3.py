...
with st.sidebar:
    opciones = option_menu(None,['Inicio', 'Experiencia', 'Gráficos'] , 
        icons=['heart-arrow', 'heart-arrow', 'heart-arrow'], menu_icon=None, default_index=0)
...
if opciones == 'Inicio':
    st.markdown("<h1 style='text-align: center;'>Blog Personal 𐔌՞. .՞𐦯</h1>", unsafe_allow_html=True)
    ...
    col1.image("Foto julia.jpg", caption='Foto tomada en interfacultades 2026', width=300)
    ...
    texto = """
    Mi nombre es Julia Fabian, tengo 20 años y soy de Lima, Perú. Actualmente estudio Periodismo en la Pontificia Universidad Católica del Perú (PUCP).
    Me apasiona la comunicación y la narración de historias, y me encanta explorar diferentes formas de expresión a través de los medios digitales.
    En el futuro, me gustaría trabajar en el ámbito del periodismo científico, contribuyendo a informar y educar a la sociedad de manera más simple sobre los hechos científicos que pasan desapercibidos.
    En mi tiempo libre, disfruto bailar cualquier género musical, nadar, leer y participar en asambleas políticas que me permitan expandir mis horizontes. 
    """
    ...
    st.markdown("<h1 style='text-align: center;'>Mi primera experiencia aprendiendo a programar 💻</h1>", unsafe_allow_html=True)

    # Agregar un  texto para la respuesta
    texto_2 = """
    En un comienzo me sentía un poco abrumada por la cantidad de información que se nos brindaba en las clases, pero poco a poco fui entendiendo los conceptos y aplicándolos en los ejercicios prácticos. 
    La programación me ha enseñado a revisar con calma cada línea de código y a pensar de manera lógica y estructurada para resolver problemas. 
    Personalmente, me gusta el hecho de que yo misma pueda crear algo desde cero y ver cómo se convierte en algo más grande, usando solo palabras. 
    A futuro me gustaría seguir aprendiendo a programar y explorar más sobre el desarrollo de aplicaciones web y móviles, ya que considero que es una habilidad muy valiosa en el mundo actual.
